...
class KT_Fieldset_Field extends KT_Field {
    ...
    public function Validate() {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            foreach ($fieldset->getFields() as $field) {
                if (!$field->Validate()) {
                    $this->setError(__("Chyba v dynamickém formuláři", "KT_CORE_DOMAIN"));
                    return false;
                }
            }
        }
    ...
    private function getFieldFooter() {
        ...
        $fieldWrapp .= "<a href = \"javascript:void(0);\" class=\"kt-add-fieldset button\">" . __("Přidat kolekci", "KT_CORE_DOMAIN") . "</a>";
        $fieldWrapp .= "</div>";
        return $fieldWrapp;
    }
    ...
    private static function getFieldsetHtml(KT_Form_Fieldset $fieldset) {
        ...
        $fieldWrapp .= "<td><a href = \"javascript:void(0);\" class=\"kt-remove-fieldset\">" . __("Odebrat", "KT_CORE_DOMAIN") . "</a><td>";
        $fieldWrapp .= "</tr>";
        return $fieldWrapp;
    }
