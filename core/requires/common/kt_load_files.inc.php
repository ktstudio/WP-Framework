...
function kt_core_register_scripts_and_styles_handlers_callback() {
    // sripts
    wp_register_script(KT_FORM_VALIDATION_SCRIPT, path_join(KT_CORE_JS_URL, "jquery.form-validation.js"), array(KT_WP_JQUERY_SCRIPT));
    wp_register_script(KT_CORE_SCRIPT, path_join(KT_CORE_JS_URL, "kt-core.js"), array(KT_WP_JQUERY_SCRIPT, KT_WP_JQUERY_UI_DATEPICKER_SCRIPT, KT_WP_JQUERY_UI_TOOLTIP_SCRIPT, KT_FORM_VALIDATION_SCRIPT));
    wp_register_script(KT_JQUERY_MAGNIFIC_POPUP_SCRIPT, path_join(KT_CORE_JS_URL, "jquery.magnific-popup.min.js"), array(KT_WP_JQUERY_SCRIPT));
    wp_register_script(KT_MAGNIFIC_POPUP_STYLE, path_join(KT_CORE_JS_URL, "kt-magnific-popup.js"), array(KT_WP_JQUERY_SCRIPT, KT_JQUERY_MAGNIFIC_POPUP_SCRIPT));
    wp_register_script(KT_GOOGLE_MAP_SCRIPT, "https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false", array(KT_WP_JQUERY_SCRIPT));
    // styles
