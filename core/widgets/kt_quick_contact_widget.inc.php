...
class KT_Quick_Contact_Widget extends KT_Widget_Base {
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id(self::EMAIL_KEY); ?>"><?php _e("E-mail", "KT_CORE_DOMAIN"); ?>:</label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id(self::SKYPE_KEY); ?>"><?php _e("Skype", "KT_CORE_DOMAIN"); ?>:</label>
